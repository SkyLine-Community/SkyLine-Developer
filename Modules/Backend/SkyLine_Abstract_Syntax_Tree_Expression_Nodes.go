...
func (ui *UnsignedLiteral) EN()              {} // Unsigned Literal   | Unsigned Literal
...
func (Case *Case) EN()                       {} // Expression Node    | Case Expression
func (Switch *Switch) EN()                   {} // Expression Node    | Switch Expression
func (Assign *AssignmentStatement) EN()      {} // Expression Node    | Assign Expression
func (ObjectCall *ObjectCallExpression) EN() {} // Expression Node    | Object Call
func (WhileCond *WhileCondition) EN()        {} // Expression Node    | While Condition
