...
func init() {
	RegisterBuiltin("io.input", func(env *Environment_of_environment, args ...Object) Object {
		return (User_Input(args...))
	})
	RegisterBuiltin("io.clear", func(env *Environment_of_environment, args ...Object) Object {
		return (IO_Clear())
	})
	RegisterBuiltin("io.box", func(env *Environment_of_environment, args ...Object) Object {
		return (IO_Box(args...))
	})
	RegisterBuiltin("io.listen", func(env *Environment_of_environment, args ...Object) Object {
